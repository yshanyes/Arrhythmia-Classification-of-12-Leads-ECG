...
* Other files:
     These files support to run the bash file and the challenge.py, such as my codes to run the model, and the model files are in official_densenet_model, official_attention_model, official_attention_onenet_model folder , etc.
